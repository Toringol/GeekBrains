...
func help() {
	fmt.Println("This is calculator usage hints\n",
		"You can use funcs: sqrt(arg), abs(arg), ln(arg), log(arg1, arg2), sin(arg), cos(arg),\n",
		"tan(arg), arcsin(arg), arccos(arg), arctan(arg), max(arg1, arg2), min(arg1, arg2\n",
		"and you can use follow operations: +, -, *, /, %, &, |, ^\n",
		"Also you can use contants e, pi and phi")
}

func main() {
	input := ""
	fmt.Println("Write help to know how to use calc")
	for {
		fmt.Print("> ")
